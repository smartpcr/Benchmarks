...
namespace Benchmarks
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine($"NetCore.App location: {typeof(string).GetTypeInfo().Assembly.Location}");
            Console.WriteLine($"NetCore.App version: {typeof(string).GetTypeInfo().GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.ToString()}");
